    ...
    <div class="container">
        <div class="row">
            <div class="column column-60 column-offset-20">
                <h2 class="text-center">Ping SMTP</h2>
                <p class="text-center">A sample project to check SMTP</p>
        ...
        <div class="row">
            <div class="column column-60 column-offset-20">
                <form method="POST" action="/smtp.php">
                    <label for="hostname">Set the SMTP server to send through</label>
                    <input type="text" name="hostname" placeholder="smtp1.example.com / IP">

                    <label for="port">Port</label>
                    <input type="number" name="port" placeholder="587">


                    <label for="secure">Secure SSL/TLS</label>
                    ...
                    <label for="recipient">Add a recipient</label>
                    <input type="email" name="recipient" placeholder="joe@example.net">

                    <label for="subject">Subject</label>
                    <input type="text" name="subject" placeholder="Here is the subject">

                    <label for="bodytext">Message Body</label>
                    <textarea name="bodytext" placeholder="Hello World..." id="commentField"></textarea>

                    <button type="submit" style="width: 100%" name="submit">Ping Now</button>
                </form>
            </div>
        </div>
    </div>
